...
class ViewReply extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const viewshopproducts(title: 'View Reply'),
    );
  }
}

class viewshopproducts extends StatefulWidget {
  const viewshopproducts({super.key, required this.title});
...
class _viewshopproductsState extends State<viewshopproducts> {
  ...
  Future<void> viewreply() async {
    ...
    try {
      ...
      String url = '$urls/myapp/user_viewshopplant/';
      ...
      for (int i = 0; i < arr.length; i++) {
        ...
        plant_name.add(arr[i]['plant_name'].toString());
        scientific_name.add(arr[i][' scientific_name'].toString());
        size.add(arr[i]['size'].toString());
        plant_type.add(arr[i]['plant_type'].toString());
      ...
      child: Scaffold(
        appBar: AppBar(
          leading: BackButton( onPressed:() {
            ...
            Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => viewshopspage(title: '',)),);
                                ...
                                children: [
                                  ...
                                  Padding(
                                      ...
                                      child:   ElevatedButton(onPressed: () async {
                                        ...
                                        // senddata();
                                        Navigator.push(context, MaterialPageRoute(builder: (context)=>viewsingleplant(title: ''),));
