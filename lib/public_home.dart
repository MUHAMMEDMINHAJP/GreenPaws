...
class HomeNew extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const Publichome(title: 'Home'),
    );
  }
}

class Publichome extends StatefulWidget {
  const Publichome({super.key, required this.title});
                    ...
                    InkWell(
                      child: CircleAvatar(
                          ...
                          backgroundImage: NetworkImage(
                              'https://cdn.business2community.com/wp-content/uploads/2018/10/notification_1540708456-900x900.png')),
                  ...
                  child: Column(children: [
                    ...
                    InkWell(
                      child: CircleAvatar(
                          radius: 50,
                          backgroundImage: NetworkImage(
                              'https://albena.bg/image/MTM4MDMuanBnLzE2MDAvMTYwMC8xLzEvODUvLy8/.jpg')),
                      onTap: () {Navigator.push(context, MaterialPageRoute(
