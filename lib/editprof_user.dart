...
class _MyEditPageState extends State<MyEditPage> {
  ...
  void _get_data() async{
    ...
    final urls = Uri.parse('$url/myapp/viewprof_user/');
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (status=='ok') {
          ...
          String phone=jsonDecode(response.body)['ph_no'].toString();
          ...
          // String qualification=jsonDecode(response.body)['qualification'].toString();
  ...
  void _send_data() async{
    ...
    final urls = Uri.parse('$url/myapp/ediprof_user/');
    try {
