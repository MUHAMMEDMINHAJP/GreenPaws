...
class ViewReply extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const viewpetshops(title: 'View Reply'),
    );
  }
}

class viewpetshops extends StatefulWidget {
  const viewpetshops({super.key, required this.title});

  final String title;

  @override
  State<viewpetshops> createState() => _viewpetshopsState();
}

class _viewpetshopsState extends State<viewpetshops> {
  ...
  List<String> shop_name_= <String>[];
  List<String> owner_name_= <String>[];
  ...
  List<String> licence_= <String>[];
  List<String> ph_no_= <String>[];
  ...
  Future<void> viewreply() async {
    ...
    try {
      ...
      String url = '$urls/myapp/user_viewpetshops/';
                                ...
                                children: [
                                  ...
                                  Padding(
                                      ...
                                      child:   ElevatedButton(onPressed: () async {
                                        SharedPreferences  sh= await SharedPreferences.getInstance();
                                        sh.setString('psid',id_[index]);
                                        // senddata();
                                        Navigator.push(context, MaterialPageRoute(builder: (context)=>viewpetshoppro(title: ''),));
