...
class HomeNew extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const UserHome2(title: 'Home'),
    );
  }
}

class UserHome2 extends StatefulWidget {
  const UserHome2({super.key, required this.title});

  final String title;

  @override
  State<UserHome2> createState() => _UserHome2State();
}
                    ...
                    Column(
                      children: [
                        Padding(
                          ...
                          child: Text("GREENPAWS! Plant Shop",
                              style: TextStyle(
                                color: Colors.white,
                                fontSize: 18,
