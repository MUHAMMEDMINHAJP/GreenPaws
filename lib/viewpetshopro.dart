...
class ViewReply extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const viewpetshoppro(title: 'View Reply'),
    );
  }
}

class viewpetshoppro extends StatefulWidget {
  const viewpetshoppro({super.key, required this.title});

  final String title;

  @override
  State<viewpetshoppro> createState() => _viewpetshopproState();
}

class _viewpetshopproState extends State<viewpetshoppro> {

  _viewpetshopproState(){
    viewreply();
  }
